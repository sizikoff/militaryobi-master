package com.obimilitaryfragments.NullModule.fragments.fragmentChooseStoreHandly.adapters;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	private HashMap<String, List<Store>> child;
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		TextView childNameStore = (TextView) convertView.findViewById(R.id.childNameStore);
		TextView childDescriptionStore = (TextView) convertView.findViewById(R.id.childDescriptionStore);

		childNameStore.setText(childStore.getName());
		childDescriptionStore.setText(childStore.getDescription());
		return convertView;
	}
	...
	public Object getGroup(int groupPosition) {
		String k = this.header.get(groupPosition);
